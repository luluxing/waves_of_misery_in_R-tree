...
public class FilteredCounterContainer extends CounterContainer {
	...
	/**
	 * Added by LX so that Hilbert R-tree can use it.
	 */
	public static  UnaryFunction<Object, Boolean> TREE_LEAF_NODE_COUNTER_FUNCTION  = new UnaryFunction<Object, Boolean>() {

		@Override
		public Boolean invoke(Object arg) {
			if(arg instanceof Tree.Node && ((Tree.Node)arg).level() == 0){
				return true;
			}
			return false;
		}
