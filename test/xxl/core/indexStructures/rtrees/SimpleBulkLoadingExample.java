...
public class SimpleBulkLoadingExample {
	 ...
	 * NOTE: change
	 */
	public static String RTREE_PATH ="./";
	
	/**
	 * Path to the California Streets (rea02.rec) data set;
	 * NOTE: change
	 */
	public static String DATA_PATH="rea02.rec";
	...
	public static Pair<RTree, CounterContainer> createAndLoadSortBased(){
		...
		Container fileContainer = new BlockFileContainer(RTREE_PATH + "bulk_loading_rtree", BLOCK_SIZE);
...
//		Pair<RTree, CounterContainer> rtree = createAndLoadSortBased();
		...
		// LX get the bulk-loaded tree and count splits
//		RTree tree = rtree.getElement1();
		Random random = new Random(42);
		PrintWriter fw = new PrintWriter("rtree_bulk_loading.txt");
		int iterNum = 2;
		int splitCount;
		int dimension = 2;
		int batchSize = 5;
		...
		System.out.println("\n--------------\n");
//		DataOutputStream dataOut = new DataOutputStream(new FileOutputStream("test_rec.rec"));
		DataOutputStream dataOut = new DataOutputStream(new FileOutputStream("test_point.pt"));
...
//				tree.insert(new DoublePointRectangle(leftCorner, rightCorner));
//				new DoublePointRectangle(leftCorner, rightCorner).write(dataOut);
				DoublePoint d = new DoublePoint(leftCorner);
				d.write(dataOut);
...
//			fw.flush();
		...
		System.out.println("\n--------------\n");
//		Converter<DoublePointRectangle> objectConverter = new ConvertableConverter<>(Rectangles.factoryFunctionDoublePointRectangle(DIMENSION));
//		Cursor cursor = new FileInputCursor<DoublePointRectangle>(objectConverter, new File("test_rec.rec"));
		Converter<DoublePoint> objectConverter = new ConvertableConverter<DoublePoint>(DoublePoint.factoryFunctionDoublePoint(DIMENSION));
		Iterator<DoublePoint> cursor = new FileInputCursor<DoublePoint>(objectConverter, new File("test_point.pt"));
		int count = 0;
