...
public class BufferedContainer extends ConstrainedDecoratorContainer {
	...
	public Object get (Object id, final boolean unfix) throws NoSuchElementException {
		...
		if (buffer.capacity() == 0) {
			object = super.get(id, unfix);
		} else {
			object = buffer.get(this, id,
...
//		super.unfix(id); // comment by LX to ensure disk I/O only happens when querying
	}
	 ...
	 * Add by LX
	 */
	public void resetBufferDisplaceNum() {
		buffer.displaceNum = 0;
	}
	 ...
	 * @return
	 */
	public int getBufferDisplaceNum() {
		return buffer.displaceNum;
	}
	...
	public double getBufferUtilization() {
		buffer.countBufferEntry();
		return buffer.getBufferUtil();
	}
	...
	public void clearBuffers() {
		buffer.removeAll(this);
		resetBufferDisplaceNum();
	}

	/**
	 * Add by LX
	 */
	public long getBufferStoredLeafEntry() { return buffer.storedLeafEntry; }
	public long getBufferStoredIndexEntry() { return buffer.storedIndexEntry; }
