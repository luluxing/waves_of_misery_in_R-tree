...
public abstract class ORTree extends Tree {
	 ...
	 * @since 1.1
	 */
	public ORTree initialize (Function getDescriptor, Container container, int blockSize, int dataSize,
							  int descriptorSize, double minMaxFactor) {
		return (ORTree)super.initialize(getDescriptor, blockSize, container, dataSize, descriptorSize, minMaxFactor);	
	}

	public ORTree initialize (IndexEntry rootEntry, Function getDescriptor, Container container, int blockSize,
							  int dataSize, int descriptorSize, double minMaxFactor) {
	...
	public class NodeConverter extends Converter {
		...
		public void write (DataOutput dataOutput, Object object) throws IOException {
			...
			LongConverter.DEFAULT_INSTANCE.write(dataOutput, new Long(node.nodeId)); // LX
	...
	*/
	...
	/**
	 * Added by LX
	 * To record the number of leaf and non-leaf node access
	 */
