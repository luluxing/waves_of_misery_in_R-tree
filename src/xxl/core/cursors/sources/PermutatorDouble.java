 ...
 * a new integer array is created. In this case {@link Random Java}'s
 ...
 * {@link Random} are created with the same seed, and the same
 ...
 */
public class PermutatorDouble extends AbstractCursor<Double> {
	 ...
	 */
	public PermutatorDouble(double[] array, Random random) {
		this.array = array;
		this.random = random;
		this.newArray = false;
	}
	 ...
	 * @param array the array the permutation should be fulfilled with.
	 */
	public PermutatorDouble(double[] array) {
	 ...
	 * @param random the pseudo random number generator (PRNG).
	 */
	public PermutatorDouble(int n, Random random) {
		this(new double[n], random);
		this.newArray = true;
	}
	 ...
	 *        the permutation should be fulfilled with.
	 */
	public PermutatorDouble(int n) {
		this(n, new Random());
	}

	public PermutatorDouble(int n, int seed) { this(n, new Random(seed)); }
